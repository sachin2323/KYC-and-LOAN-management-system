...
docker exec -it cli peer chaincode instantiate -o orderer.example.com:7050 -C mychannel -n mycc github.com/chaincode -v v1 -c '{"Args": ["addEntity", "insurer1", "Priyansh", "Insurer"]}'