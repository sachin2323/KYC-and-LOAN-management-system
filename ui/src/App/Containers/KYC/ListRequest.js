  ...
  constructor(props) {
    ...
    this.state = {
      ...
      options : [
        ...
        { label: 'Identification Form', value: 'IdentificationForm' },
        { label: 'Nationality', value: 'Nationality' },
        { label: 'E-mail', value: 'EmailAddress' },
        { label: 'National Age Card', value: 'NationalAgeCard' },
        { label: 'Utility Bills', value: 'UtilityBills' },
        { label: 'Home Insurance', value: 'HomeInsurance' },
        { label: 'Car Insurance', value: 'CarInsurance' },
        { label: 'Tax Credit Certificate', value: 'TaxCreditCertificate' },
        { label: 'Salary Certificate', value: 'SalaryCertificate' },
        { label: 'Employee Pay Slip', value: 'EmployeePayslip' },
